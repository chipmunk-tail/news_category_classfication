...
#
# 사이트 HTML에서 뉴스 헤드라인만 추출해 csv파일을 생성하는 코드
...
# Crawling hedaline and save
for i in range(6):                                              # domain range : 100 ~ 105
    ...
    df_section_titles = pd.DataFrame(titles, columns = ['titles'])  # Create temp dataframe
    df_section_titles['category'] = category[i]                     # insert category
